...
[![GoDoc](https://godoc.org/github.com/Shopify/asynq?status.svg)](https://godoc.org/github.com/Shopify/asynq)
[![Go Report Card](https://goreportcard.com/badge/github.com/Shopify/asynq)](https://goreportcard.com/report/github.com/Shopify/asynq)
![Build Status](https://github.com/Shopify/asynq/workflows/build/badge.svg)
...
```sh
go get -u github.com/Shopify/asynq
```
...
In your application code, import the above package and use [`Client`](https://pkg.go.dev/github.com/Shopify/asynq?tab=doc#Client) to put tasks on queues.
...
Next, start a worker server to process these tasks in the background. To start the background workers, use [`Server`](https://pkg.go.dev/github.com/Shopify/asynq?tab=doc#Server) and provide your [`Handler`](https://pkg.go.dev/github.com/Shopify/asynq?tab=doc#Handler) to process the tasks.

You can optionally use [`ServeMux`](https://pkg.go.dev/github.com/Shopify/asynq?tab=doc#ServeMux) to create a handler, just as you would with [`net/http`](https://golang.org/pkg/net/http/) Handler.
...
[Asynqmon](https://github.com/Shopify/asynqmon) is a web based tool for monitoring and administrating Asynq queues and tasks.
...
For details on how to use the tool, refer to the tool's [README](https://github.com/Shopify/asynqmon#readme).
...
```sh
go install github.com/Shopify/asynq/tools/asynq
```
...
Copyright (c) 2019-present [Ken Hibino](https://github.com/Shopify/asynq) and [Contributors](https://github.com/Shopify/asynq/graphs/contributors). `Asynq` is free and open-source software licensed under the [MIT License](https://github.com/hibiken/asynq/blob/master/LICENSE). Official logo was created by [Vic Shóstak](https://github.com/koddr) and distributed under [Creative Commons](https://creativecommons.org/publicdomain/zero/1.0/) license (CC0 1.0 Universal).
